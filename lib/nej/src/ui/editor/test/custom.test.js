var f = function(){
    ...
    test('生成一个富文本编辑器',function(){
        ...
        this._v._$addEvent(_istiframe,'click',function(){
            window._custom.__editor.__copt.area._$execCommand('inserthtml','<iframe width="400" height="300" class="videoPlayer" src="/res/videoplayer/asset/index.html?src=http%3A%2F%2Fnos-yx.netease.com%2Fyixinpublic%2Fpr_7puzwahrjwnicckqack1tg%3D%3D_1433388652_8618_translated.mp4&amp;type=mp4&amp;full=false" frameborder="0"></iframe>')
        }._$bind(this));
    });
}
module('依赖模块');
